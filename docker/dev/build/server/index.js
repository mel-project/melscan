import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './chunks/index-e26e4552-f700655a.js';
...
const template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + `/favicon.png" />
		...
		/>
		<style>
			@import 'https://themelio.org/iosevka-aile/iosevka-aile.css';
...
class Server {
  ...
  async respond(request, options = {}) {
    ...
    if (!this.options.hooks) {
      const module = await import('./chunks/hooks-bced8853-64fbdb54.js');
      this.options.hooks = {
